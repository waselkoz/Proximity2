...
export default function GraphicDesignPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F4F4F4] text-[#0A0A0A] font-sans selection:bg-[#90243B] selection:text-white pb-20">
      ...
      {/* Navigation Bar */}
      <nav className="w-full p-6 sm:p-10 flex justify-between items-center fixed top-0 z-50 mix-blend-difference pointer-events-none">
      ...
      <section ref={containerRef} className="relative w-full h-[120vh] sm:h-[180vh] bg-[#111]">
          <div className="sticky top-0 w-full h-screen overflow-hidden flex items-center justify-center">
              ...
              <motion.div 
                ...
                className="absolute z-50 text-center pointer-events-none mix-blend-difference text-white"
              >
