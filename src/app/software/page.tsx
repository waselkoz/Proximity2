...
export default function SoftwareEngineering() {
 ...
 <h2 className="text-[12vw] sm:text-[10vw] font-black uppercase tracking-tighter leading-none text-white transition-all duration-700 group-hover:tracking-normal group-hover:scale-105">
 ACCESS ARCHIVES
 </h2>
 </Link>
 </section>
 ...
 className="w-full max-w-md flex flex-col items-center justify-center border border-white/20 bg-white/5 p-12 text-center relative z-10 "
 >
