  ...
  return (
    <div className="w-full min-h-screen bg-[#0A0A0A] text-white flex flex-col items-center justify-center p-5">
       <div className="max-w-3xl text-center">
           <div className="font-mono text-[10px] text-[#90243B] uppercase tracking-[0.2em] mb-4">Service // Video Editing</div>
           <h1 className="text-4xl sm:text-7xl font-black uppercase tracking-tighter mb-8">Cinematic Motion<br/>Coming Soon.</h1>
